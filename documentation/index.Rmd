...
**IMPORTANT**: This template is just an example to facilitate getting started
with R-markdown and its processing using multiple files. You do not have to do
the analyses exactly in the same way as they are done here. Please read
carefully the description of the project, and its technical requirements to
know what to do. In particular, when you carry out the second part of the
project, you should conduct the differential expression analysis in the way
that best suits the questions you want to address. You do not need to do
analysis in every possible way, just in one way, in the way you think makes
more sense to you. IF YOU THINK AN ANALYSIS OR DIAGNOSTIC DOES NOT MAKE SENSE,
OR IT IS NOT JUSTIFIED, YOU SHOULD NOT DO IT.
