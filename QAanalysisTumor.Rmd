...
```{r libsizestumor, echo=FALSE, fig.cap="Library sizes in increasing order."}
...
```{r distRawExpAllTumor, echo=FALSE, fig.height=4, fig.width=10, out.width="800px", fig.cap="Non-parametric density distribution of expression profiles per sample.", message=FALSE}
...
```{r distRawExpCompTumor, echo=FALSE, fig.height=8, fig.width=10, out.width="800px", fig.cap="Non-parametric density distribution of expression profiles per sample.", message=FALSE}
...
```{r exprdisttumor, echo=FALSE, fig.cap="Distribution of average expression level per gene."}
