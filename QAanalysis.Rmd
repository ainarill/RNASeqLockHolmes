...
From this information we can make the following observations:
  ...
  * Samples were collected across 4 different tissue source sites (TSS), with poor representation of one of them (F4).
  
  * All samples were sequenced at the same center.
  
  * Samples were sequenced in different plates.

  * 44 samples belong to solid tumor samples whereas 39 do not. 3 of the 44 solid tumor samples belong to different vials (B and C), the 41 left plus de 39 that are not solid tumors coincide in vial (A).
  
  * The analyte of all samples is a RNA sample, as we expected.

We are going to use the 'sample vial' as surrogate of batch effect indicator. Considering our outcome of interest as molecular changes between sample types, tumor vs. normal, we will examine now the cross-classification of this outcome with sample-vial information.
