...
In this RNA-seq data we have a total of 524 samples (483 tumor samples and 41 non-tumor samples). In order to know more about the data, we explore the `colData` column, that corresponds to clinical variables, and their corresponding metadata.
