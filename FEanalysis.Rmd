...
```{r scatter_plot2, fig.align = 'center'}
...
As we can see in \@ref(fig:scatter_plot2), there are represented the 6 gene sets with a higher χ2-score. As seen in the Z-score ranking gene sets, in overall most of the genes are down regulated in the tumor group. 
