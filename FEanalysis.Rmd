...
genesGS1 <- rowData(coadse.filt)[top1G,1]
genesGS1
...
plotGS(coadse.filt, top2G, "type", main = names(rnkGS_Z)[2], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top3G, "type", main = names(rnkGS_Z)[3], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top4G, "type", main = names(rnkGS_Z)[4], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top5G, "type", main = names(rnkGS_Z)[5], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top6G, "type", main = names(rnkGS_Z)[6], cex.main = 0.7, cex.lab = 2, las = 1)
```

We can see the top6 gene sets according to the Z-score. In general the distribution of the genes in the gene set are mainly downregulated in tumor cases respect to normal. 
