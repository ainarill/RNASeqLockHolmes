...
plotGS(coadse.filt, top2G, "type", dge.filt, main = names(rnkGS_Z)[9], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top3G, "type", dge.filt, main = names(rnkGS_Z)[15], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top4G, "type", dge.filt, main = names(rnkGS_Z)[3], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top5G, "type", dge.filt, main = names(rnkGS_Z)[10], cex.main = 0.7, cex.lab = 2, las = 1)
plotGS(coadse.filt, top6G, "type", dge.filt, main = names(rnkGS_Z)[37], cex.main = 0.7, cex.lab = 2, las = 1)
```
